...
## Kyu's Birthday! | <Highlight>01/26/2022</Highlight>
...
<Highlight style={{fontWight: 'bold'}}>KyuBeta</Highlight><br/>
I've shown a few leaks, but over the last 3-4 months we have been working on rewriting the whole bot and bring tons of new features. We'll have a list of updates available soon but for now you can checkout @KyuBeta and invite the bot to your servers!
<br/>
<Highlight style={{fontWight: 'bold'}}>Caution</Highlight><br/>
The database for @KyuBeta is different to the main bot, @KyuBeta database will be randomly deleted to fix issues, so please don't use that as your main bot! We also expect random downtimes which will not be announced anywhere.
...
## Update 2.1.1 | <Highlight>10/11/2022</Highlight>
